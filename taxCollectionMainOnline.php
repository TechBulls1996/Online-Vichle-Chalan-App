...
<div>
        ...
        <div class="ui-grid-row">
            ...
            <div class="ui-grid-col-6">
                ...
                </label><input id="j_idt623" name="j_idt623" type="text" class="ui-inputfield ui-inputtext ui-widget ui-state-default ui-corner-all ui-state-disabled" disabled="disabled" aria-disabled="true" autocomplete="off" maxlength="50" onkeypress="return AlphaWithSpaceOnly(event, '. ');" onkeyup="makeCaps(this);" role="textbox" aria-readonly="false">
            </div>
        </div>
        <div class="ui-grid-row">
            <div class="ui-grid-col-6">
