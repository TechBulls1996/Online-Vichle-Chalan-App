    ...
    <div class="container-fluid">
        <div class="ui-grid ui-grid-responsive">
            <div class="ui-grid-row top-space center-position contents-Space">
                <h1 class="header-main"><label id="j_idt41" class="ui-outputlabel ui-widget header-main" style="color: #154281!important;font-weight: bold!important;">BORDER TAX PAYMENT FOR ENTRY
                        INTO</label><span class="red"> <?= @$states_reverse[$_POST['ib_state_input']] ?></span></h1>
            </div>
            ...
            <div class="ui-grid-row top-space">
                ...
                <div class="ui-grid-col-10">
                    <div id="hrtaxcollection" class="ui-panel ui-widget ui-widget-content ui-corner-all bottom-space" data-widget="widget_hrtaxcollection">
                        ...
                        <div id="hrtaxcollection_content" class="ui-panel-content ui-widget-content">
                            ...
                            <div class="ui-grid-row">
                                ...
                                <div class="ui-grid-col-6">
                                    <label class="field-label resp-label-section">
                                        <label id="j_idt628" class="ui-outputlabel ui-widget field-label-mandate">From
                                            State</label>
                                    </label>
                                    <div id="ib_state" class="ui-selectonemenu ui-widget ui-state-default ui-corner-all" role="combobox" aria-haspopup="true" aria-expanded="false">
                                        ...
                                        <div class="ui-helper-hidden-accessible">
                                            <select id="ib_state_input" name="ib_state_input" tabindex="-1" aria-hidden="true" onchange="PrimeFaces.ab({s:&quot;ib_state&quot;,e:&quot;change&quot;,f:&quot;master_Layout_form&quot;,p:&quot;ib_state&quot;,u:&quot;operation_code&quot;});">
                                                <option value="-1" data-escape="true">---Select State---</option>
                                                <?php
                                        ...
                                        <div id="ib_state_panel" class="ui-selectonemenu-panel ui-widget ui-widget-content ui-corner-all ui-helper-hidden ui-shadow ui-input-overlay">
                                    ...
                                    <script id="ib_state_s" type="text/javascript">
                                        $(function() {
                                            PrimeFaces.cw("SelectOneMenu", "widget_ib_state", {
                                                id: "ib_state",
                                                appendTo: "@(body)",
                                                filter: true,
                                                behaviors: {
                            ...
                            <div class="ui-grid-row">
                                <div class="ui-grid-col-6">
                                    <label class="field-label resp-label-section">
                                        <label id="j_idt634" class="ui-outputlabel ui-widget field-label-mandate">Vehicle Permit
                                            Type</label>
                                    </label>
                                    <div id="ib_state" class="ui-selectonemenu ui-widget ui-state-default ui-corner-all" role="combobox" aria-haspopup="true" aria-expanded="false">
                                        <div class="ui-helper-hidden-accessible">
                                        ...
                                        <div class="ui-helper-hidden-accessible">
                                            <select id="ib_vehicle_input" name="ib_vehicle_input" tabindex="-1" aria-hidden="true" onchange="PrimeFaces.ab({s:&quot;ib_vehicle&quot;,e:&quot;change&quot;,f:&quot;master_Layout_form&quot;,p:&quot;ib_vehicle&quot;,u:&quot;operation_code&quot;});">
                                                <option value="-1" data-escape="true">---Select Vehicle Permit Type---
                                                </option>
                                                <?php
                                        ...
                                        </div><label id="ib_vehicle_label" class="ui-selectonemenu-label ui-inputfield ui-corner-all">&nbsp;</label>

                                        <div class="ui-selectonemenu-trigger ui-vehicle-default ui-corner-right">
                                            <span class="ui-icon ui-icon-triangle-1-s ui-c"></span>
                                        </div>
                                        <div id="ib_vehicle_panel" class="ui-selectonemenu-panel ui-widget ui-widget-content ui-corner-all ui-helper-hidden ui-shadow ui-input-overlay">
                                            <div class="ui-selectonemenu-filter-container">
                                                <input class="ui-selectonemenu-filter ui-inputfield ui-inputtext ui-widget ui-vehicle-default ui-corner-all" id="ib_vehicle_filter" name="ib_vehiclee_filter" type="text" autocomplete="off"><span class="ui-icon ui-icon-search"></span>
                                            </div>
                                            <div class="ui-selectonemenu-items-wrapper" style="max-height:200px">

                                                <ul id="ib_vehicle_items" class="ui-selectonemenu-items ui-selectonemenu-list ui-widget-content ui-widget ui-corner-all ui-helper-reset" role="listbox">

                                                    <li class="ui-selectonemenu-item ui-selectonemenu-list-item ui-corner-all" data-label="---Select Vehicle---" tabindex="-1" role="option">
                                                        ---Select Vehicle Permit Type---</li>
                                                    <?php
                                                    // Access the data
                                                    foreach ($VEHICLE_TYPE as $key => $val) {
                                    ...
                                    <script id="ib_vehicle_s" type="text/javascript">
                                        $(function() {
                                            PrimeFaces.cw("SelectOneMenu", "widget_ib_vehicle", {
                                                id: "ib_vehicle",
                                                appendTo: "@(body)",
                                                filter: true,
                                                behaviors: {
                                ...
                                <div class="ui-grid-col-6">
                                    <label class="field-label resp-label-section"><label id="j_idt634" class="ui-outputlabel ui-widget field-label-mandate">Vehicle Permit
                                            Type</label>
                                    </label>
                                    <div id="j_idt636" class="ui-selectonemenu ui-widget ui-vehicle-default ui-corner-all" role="combobox" aria-haspopup="true" aria-expanded="false" aria-owns="j_idt636_items" style="min-width: 338px;">
                                        <div class="ui-helper-hidden-accessible"><input id="j_idt636_focus" name="j_idt636_focus" type="text" autocomplete="off" aria-expanded="false" aria-autocomplete="list" aria-activedescendant="j_idt636_0" aria-describedby="j_idt636_0" aria-disabled="false"></div>
                                        <div class="ui-helper-hidden-accessible"><select id="j_idt636_input" name="j_idt636_input" tabindex="-1" aria-hidden="true" onchange="PrimeFaces.ab({s:&quot;j_idt636&quot;,e:&quot;change&quot;,f:&quot;master_Layout_form&quot;,p:&quot;hrtaxcollection&quot;,u:&quot;hrtaxcollection&quot;});">
                                                <option value="-1" data-escape="true">---Select Vehicle Type---</option>
                                                <option value="1" data-escape="true">CONTRACT CARRIAGE/PASSENGER
                                                    VEHICLES</option>
                                                <option value="2" data-escape="true">PRIVATE SERVICE VEHICLE</option>
                                                <option value="3" data-escape="true">GOODS VEHICLE</option>
                                                <option value="4" data-escape="true">STAGE CARRIAGE</option>
                                                <option value="9" data-escape="true">CONSTRUCTION EQUIPMENT VEHICLE
                                                </option>
                                            </select></div><label id="j_idt636_label" class="ui-selectonemenu-label ui-inputfield ui-corner-all">---Select Vehicle
                                            Type---</label>
                                        <div class="ui-selectonemenu-trigger ui-vehicle-default ui-corner-right"><span class="ui-icon ui-icon-triangle-1-s ui-c"></span></div>
                                    </div>
                                </div>
                                <div class="ui-grid-col-6">
                                    ...
                                    <div id="j_idt642" class="ui-selectonemenu ui-widget ui-state-default ui-corner-all" role="combobox" aria-haspopup="true" aria-expanded="false" aria-owns="j_idt642_items" style="min-width: 175px;">
                                        <div class="ui-helper-hidden-accessible"><input id="j_idt642_focus" name="j_idt642_focus" type="text" autocomplete="off" aria-expanded="false" aria-autocomplete="list" aria-activedescendant="j_idt642_0" aria-describedby="j_idt642_0" aria-disabled="false"></div>
                                        <div class="ui-helper-hidden-accessible"><select id="j_idt642_input" name="j_idt642_input" tabindex="-1" aria-hidden="true" onchange="PrimeFaces.ab({s:&quot;j_idt642&quot;,e:&quot;change&quot;,f:&quot;master_Layout_form&quot;,p:&quot;hrtaxcollection&quot;,u:&quot;hrtaxcollection&quot;});">
                                                <option value="-1" data-escape="true">---Select Vehicle Class---
                                                </option>
                                            </select></div><label id="j_idt642_label" class="ui-selectonemenu-label ui-inputfield ui-corner-all">---Select Vehicle
                                            Class---</label>
                            ...
                            <div class="ui-grid-row">
                                <div class="ui-grid-col-6">
                                    <label class="field-label resp-label-section"><label id="lbl_seat_cap" class="ui-outputlabel ui-widget field-label-mandate">Seating Capacity
                                            (Excluding Driver)</label>
                                ...
                                <div class="ui-grid-col-6">
                                    ...
                                    <div id="cmb_service_type" class="ui-selectonemenu ui-widget ui-state-default ui-corner-all" role="combobox" aria-haspopup="true" aria-expanded="false" aria-owns="cmb_service_type_items" style="min-width: 172px;">
                                        <div class="ui-helper-hidden-accessible"><input id="cmb_service_type_focus" name="cmb_service_type_focus" type="text" autocomplete="off" aria-expanded="false" aria-autocomplete="list" aria-activedescendant="cmb_service_type_0" aria-describedby="cmb_service_type_0" aria-disabled="false"></div>
                                        <div class="ui-helper-hidden-accessible"><select id="cmb_service_type_input" name="cmb_service_type_input" tabindex="-1" aria-hidden="true" onchange="PrimeFaces.ab({s:&quot;cmb_service_type&quot;,e:&quot;change&quot;,f:&quot;master_Layout_form&quot;,p:&quot;hrtaxcollection&quot;,u:&quot;hrtaxcollection&quot;});">
                                                <option value="-1" data-escape="true">---Select Service Type---</option>
                                            </select></div><label id="cmb_service_type_label" class="ui-selectonemenu-label ui-inputfield ui-corner-all">---Select Service
                                            Type---</label>
                                        <div class="ui-selectonemenu-trigger ui-state-default ui-corner-right"><span class="ui-icon ui-icon-triangle-1-s ui-c"></span></div>
                                    </div>
                                </div>
                            ...
                            <div class="ui-grid-row">
                                ...
                                <div class="ui-grid-col-6">
                                    ...
                                    <div id="cmb_payment_mode" class="ui-selectonemenu ui-widget ui-state-default ui-corner-all" role="combobox" aria-haspopup="true" aria-expanded="false" aria-owns="cmb_payment_mode_items" style="min-width: 185px;">
                                        <div class="ui-helper-hidden-accessible"><input id="cmb_payment_mode_focus" name="cmb_payment_mode_focus" type="text" autocomplete="off" aria-expanded="false" aria-autocomplete="list" aria-activedescendant="cmb_payment_mode_0" aria-describedby="cmb_payment_mode_0" aria-disabled="false"></div>
                                        <div class="ui-helper-hidden-accessible"><select id="cmb_payment_mode_input" name="cmb_payment_mode_input" tabindex="-1" aria-hidden="true" onchange="PrimeFaces.ab({s:&quot;cmb_payment_mode&quot;,e:&quot;change&quot;,f:&quot;master_Layout_form&quot;,p:&quot;hrtaxcollection&quot;,u:&quot;hrtaxcollection&quot;});">
                                                <option value="-1" data-escape="true">---Select Payment Mode---</option>
                                            </select></div><label id="cmb_payment_mode_label" class="ui-selectonemenu-label ui-inputfield ui-corner-all">---Select Payment
                                            Mode---</label>
                                        <div class="ui-selectonemenu-trigger ui-state-default ui-corner-right"><span class="ui-icon ui-icon-triangle-1-s ui-c"></span></div>
                                    </div>
                                </div>
                            ...
                            <div class="ui-grid-row">
                                <div class="ui-grid-col-6">
                                    <label class="field-label resp-label-section"><label id="j_idt660" class="ui-outputlabel ui-widget field-label-mandate">Border/Barrier District
                                            through Entering</label>
                                    </label>
                                    <div id="j_idt662" class="ui-selectonemenu ui-widget ui-state-default ui-corner-all" role="combobox" aria-haspopup="true" aria-expanded="false" aria-owns="j_idt662_items" style="min-width: 179.5px;">
                                        <div class="ui-helper-hidden-accessible"><input id="j_idt662_focus" name="j_idt662_focus" type="text" autocomplete="off" aria-expanded="false" aria-autocomplete="list" aria-activedescendant="j_idt662_0" aria-describedby="j_idt662_0" aria-disabled="false"></div>
                                        <div class="ui-helper-hidden-accessible"><select id="j_idt662_input" name="j_idt662_input" tabindex="-1" aria-hidden="true">
                                                <option value="-1" data-escape="true">---Select District/Barrier---
                                                </option>
                                            ...
                                            </select></div><label id="j_idt662_label" class="ui-selectonemenu-label ui-inputfield ui-corner-all">---Select
                                            District/Barrier---</label>
                                        <div class="ui-selectonemenu-trigger ui-state-default ui-corner-right"><span class="ui-icon ui-icon-triangle-1-s ui-c"></span></div>
                                    </div>
                                </div>
                                        ...
                                        <div class="ui-datatable-tablewrapper">
                                            <table role="grid">
                                                <thead id="taxList_head">
                                                    <tr role="row">
                                                        <th id="taxList:j_idt672" class="ui-state-default" role="columnheader" aria-label="Sl. No." scope="col" style="width: 40px;"><span class="ui-column-title">Sl.
                                                                No.</span></th>
                                                        <th id="taxList:j_idt674" class="ui-state-default" role="columnheader" aria-label="Particulars" scope="col">
                                                            <span class="ui-column-title">Particulars</span>
                                                        </th>
                                                        <th id="taxList:j_idt676" class="ui-state-default" role="columnheader" aria-label="Tax From" scope="col"><span class="ui-column-title">Tax From</span></th>
                                                        <th id="taxList:j_idt678" class="ui-state-default" role="columnheader" aria-label="Tax Upto" scope="col"><span class="ui-column-title">Tax Upto</span></th>
                                                        <th id="taxList:j_idt680" class="ui-state-default" role="columnheader" aria-label="Amount" scope="col"><span class="ui-column-title">Amount</span></th>
                                                    </tr>
                                                </thead>
                    ...
                    <div id="popup" class="ui-dialog ui-widget ui-widget-content ui-corner-all ui-shadow ui-hidden-container center-position ui-resizable" role="dialog" aria-labelledby="popup_title" aria-describedby="popup_content" aria-hidden="true" aria-modal="true" style="width: auto; height: auto;">
                    ...
                    <div id="ConfirmationDialog" class="ui-dialog ui-widget ui-widget-content ui-corner-all ui-shadow ui-hidden-container ui-draggable" role="dialog" aria-labelledby="ConfirmationDialog_title" aria-describedby="ConfirmationDialog_content" aria-hidden="true" aria-modal="true" style="width: 550px; height: auto;">
                        <div class="ui-dialog-titlebar ui-widget-header ui-helper-clearfix ui-corner-top ui-draggable-handle">
                            <span id="ConfirmationDialog_title" class="ui-dialog-title">Confirmation Message...</span><a href="#" class="ui-dialog-titlebar-icon ui-dialog-titlebar-close ui-corner-all" aria-label="Close" role="button"><span class="ui-icon ui-icon-closethick"></span></a>
                        </div>
                        <div class="ui-dialog-content ui-widget-content" id="ConfirmationDialog_content" style="height: 260px;">
