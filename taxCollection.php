...
<form id="master_Layout_form" name="master_Layout_form" method="post" action="<?= $URL; ?>/taxCollection.php"
    ...
    <div>
        <div id="popup"
            ...
            <div class="ui-dialog-content ui-widget-content" id="popup_content">
                ...
                <button id="j_idt42" name="j_idt42"
                    class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                    onclick="PrimeFaces.bcn(this,event,[function(event){mojarra.ab('j_idt42',event,'click',0,'publicsignup popup')},function(event){PrimeFaces.ab({s:&quot;j_idt42&quot;,f:&quot;master_Layout_form&quot;,onco:function(xhr,status,args){PF('dlg1').hide();;}});return false;}]);"
                    type="submit"><span class="ui-button-text ui-c">Ok</span></button>

                <script id="j_idt42_s" type="text/javascript">
                $(function() {
                    PrimeFaces.cw("CommandButton", "widget_j_idt42", {
                        id: "j_idt42",
                        behaviors: {
                            click: function(ext, event) {
                                mojarra.ab('j_idt42', event, 'click', 0, 'publicsignup popup', {
            ...
            <div class="ui-grid ui-grid-responsive">
                ...
                <div class="ui-grid-row">
                    ...
                    <div class="ui-grid-col-12">
                        <div id="publicsignup" class="ui-panel ui-widget ui-widget-content ui-corner-all"
                            data-widget="widget_publicsignup">
                            <div id="publicsignup_header"
                                class="ui-panel-titlebar ui-widget-header ui-helper-clearfix ui-corner-all"><span
                                    class="ui-panel-title">Select State Name for Tax Payment</span></div>
                            <div id="publicsignup_content" class="ui-panel-content ui-widget-content">
                                <div class="ui-grid-row">
                                    ...
                                    <div class="ui-grid-col-5">
                                        ...
                                        <div id="ib_state"
                                            ...
                                            <div class="ui-helper-hidden-accessible">
                                                <input id="ib_state_focus" name="ib_state_focus" type="text"
                                                    autocomplete="off" aria-expanded="false" aria-required="true">
                                            </div>
                                            <div class="ui-helper-hidden-accessible">
                                                <select id="ib_state_input" name="ib_state_input" tabindex="-1"
                                                    aria-hidden="true"
                                                    onchange="PrimeFaces.ab({s:&quot;ib_state&quot;,e:&quot;change&quot;,f:&quot;master_Layout_form&quot;,p:&quot;ib_state&quot;,u:&quot;operation_code&quot;});">
                                    ...
                                    ?>
                                            ...
                                            </div><label id="ib_state_label"
                                                class="ui-selectonemenu-label ui-inputfield ui-corner-all">&nbsp;</label>

                                            <div class="ui-selectonemenu-trigger ui-state-default ui-corner-right">
                                                <span class="ui-icon ui-icon-triangle-1-s ui-c"></span>
                                            </div>
                                            <div id="ib_state_panel"
                                                class="ui-selectonemenu-panel ui-widget ui-widget-content ui-corner-all ui-helper-hidden ui-shadow ui-input-overlay">
                                                <div class="ui-selectonemenu-filter-container">
                                                    <input
                                                        class="ui-selectonemenu-filter ui-inputfield ui-inputtext ui-widget ui-state-default ui-corner-all"
                                                        id="ib_state_filter" name="ib_state_filter" type="text"
                                                        autocomplete="off"><span class="ui-icon ui-icon-search"></span>
                                                </div>
                                                <div class="ui-selectonemenu-items-wrapper" style="max-height:200px">

                                                    <ul id="ib_state_items"
                                                        ...
                                                        <li class="ui-selectonemenu-item ui-selectonemenu-list-item ui-corner-all"
                                                            data-label="---Select State---" tabindex="-1" role="option">
                                                            ---Select State---</li>
                                                        <?php
                                // Access the data
                                foreach ($data as $state => $code) {
                                ...
                                ?>
                                    ...
                                    <div class="ui-grid-col-5">
                                        ...
                                        <div id="operation_code"
                                            class="ui-selectonemenu ui-widget ui-state-default ui-corner-all"
                                            style="width:90%!important;" role="combobox" aria-haspopup="true"
                                            aria-expanded="false">
                                            <div class="ui-helper-hidden-accessible"><input id="operation_code_focus"
                                                    name="operation_code_focus" type="text" autocomplete="off"
                                                    aria-expanded="false" aria-required="true"></div>
                                            <div class="ui-helper-hidden-accessible"><select id="operation_code_input"
                                                    name="operation_code_input" tabindex="-1" aria-hidden="true">
                                                    <option value="-1" data-escape="true">---Select Service Name---
                                                    </option>
                                                </select></div><label id="operation_code_label"
                                                class="ui-selectonemenu-label ui-inputfield ui-corner-all">&nbsp;</label>
                                            <div class="ui-selectonemenu-trigger ui-state-default ui-corner-right"><span
                                                    class="ui-icon ui-icon-triangle-1-s ui-c"></span></div>
                                            <div id="operation_code_panel"
                                                class="ui-selectonemenu-panel ui-widget ui-widget-content ui-corner-all ui-helper-hidden ui-shadow ui-input-overlay">
                                                <div class="ui-selectonemenu-filter-container"><input
                                                        class="ui-selectonemenu-filter ui-inputfield ui-inputtext ui-widget ui-state-default ui-corner-all"
                                                        id="operation_code_filter" name="operation_code_filter"
                                                        type="text" autocomplete="off"><span
                                                        class="ui-icon ui-icon-search"></span></div>
                                                <div class="ui-selectonemenu-items-wrapper" style="max-height:200px">
                                                    <ul id="operation_code_items"
                                                        class="ui-selectonemenu-items ui-selectonemenu-list ui-widget-content ui-widget ui-corner-all ui-helper-reset"
                                                        role="listbox">
                                                        <li class="ui-selectonemenu-item ui-selectonemenu-list-item ui-corner-all"
                                                            data-label="---Select Service Name---" tabindex="-1"
                                                            role="option">---Select Service Name---</li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                        <script id="operation_code_s" type="text/javascript">
                                        $(function() {
                                            PrimeFaces.cw("SelectOneMenu", "widget_operation_code", {
                                                id: "operation_code",
                                                appendTo: "@(body)",
                                                filter: true
                                            });
                                ...
                                <div class="ui-grid-row top-space">
                                    <div class="ui-grid-col-12 center-position">
                                        <button id="j_idt51" name="j_idt51"
                                            class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-left"
                                            onclick="submitForm(e)" type="submit"><span
                                                class="ui-button-icon-left ui-icon ui-c ui-icon-seek-next"></span><span
                                                class="ui-button-text ui-c">Go</span></button>
                        ...
                        <script id="publicsignup_s" type="text/javascript">
                        $(function() {
                            PrimeFaces.cw("Panel", "widget_publicsignup", {
                                id: "publicsignup"
                            });
                        });
                        </script><br>
                        <div id="j_idt55" class="ui-panel ui-widget ui-widget-content ui-corner-all"
                            style="font-size: 11pt;" data-widget="widget_j_idt55">
                            <div id="j_idt55_header"
                                class="ui-panel-titlebar ui-widget-header ui-helper-clearfix ui-corner-all"><span
                                    class="ui-panel-title">Follow these steps to initiate tax payment...</span></div>
                            <div id="j_idt55_content" class="ui-panel-content ui-widget-content">
                                <ol>
                                    <li> Select the state where you want to go from <font class="dialog-highlight-text">
                                            'Select State'</font> combo box.</li>
                                    <li> Select service Name from <font class="dialog-highlight-text">'Service Name'
                                        </font> combo box.</li>
                                    <ol type="i">
                                        <li type="i"> Select <font class="dialog-highlight-text">'VEHICLE TAX COLLECTION
                                                (OTHER STATE)'</font> in case you do not have NCR permit.</li>
                                        <li type="i"> Select <font class="dialog-highlight-text">'VEHICLE TAX COLLECTION
                                                (NCR)'</font> in case you have NCR permit.</li>
                                    </ol>
                                    <li> Click <font class="dialog-highlight-text">'Go'</font> button to open the
                                        vehicle details form.</li>
                                    <li> Enter <font class="dialog-highlight-text">'Vehicle No.'</font> and click <font
                                            class="dialog-highlight-text">'Get Details'</font> button to fill the
                                        details.</li>
                                    <li> Fill rest of the fields which are not filled automatically.</li>
                                    <li> In case fields are not filled automatically then enter the details manually.
                                    </li>
                                    <li> Click <font class="dialog-highlight-text">'Calculate Tax'</font> button to
                                        calculate the tax according to state notification.</li>
                                    <li> Click <font class="dialog-highlight-text">'Pay Tax'</font> button to pay the
                                        calculated tax.</li>
                                    <li> It opens the payment gateway of VAHAN.</li>
                                    <li> Choose payment gateway and click on <font class="dialog-highlight-text">
                                            'Continue'</font> button.</li>
                                    <li> And then follow the screen to pay tax.</li>
                                    <li> After paying tax bank will redirect to the Checkpost application.</li>
                                    <li> In case payment is success Checkpost application will generate the success
                                        receipt.</li>
                        ...
                        $(function() {
                            PrimeFaces.cw("Panel", "widget_j_idt55", {
                                id: "j_idt55"
                            });
                        });
                        </script>
