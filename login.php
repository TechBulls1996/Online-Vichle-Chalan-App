            ...
            <div class="ui-grid ui-grid-responsive">
                <div class="ui-grid-row">
                    <div class="ui-grid-col-2 left_logo">
                        <a class="top-space inline-section"><img id="j_idt23" src="/checkpost/faces/javax.faces.resource/checkpost-logo.png?ln=images" alt="Check Post Logo" />
                        </a>
                    </div>
                    <div class="ui-grid-col-8">
                        <div class="heading_w center-position top-space"><img id="j_idt25" src="/checkpost/faces/javax.faces.resource/emblem-logo.png?ln=images" class="emblem-logo" alt="State Emblem of India" />
                    ...
                    <div class="ui-grid-col-2 right_logo">
                        <a class="top-space inline-section"><img id="j_idt27" src="/checkpost/faces/javax.faces.resource/e-vahan-logo.png?ln=images" alt="e-Vahan Logo" />
                        </a>
                    </div>
                </div>
            </div>
