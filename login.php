...
<form id="master_Layout_form" name="master_Layout_form" method="post" action="/login.php"
    ...
    <div class="main_news_w2">
        <div class="news_w">
            <div data-direction="left" class="marquee-with-options">
                <marquee scrollamount="6" onmouseover="this.stop();" onmouseout="this.start();" direction="left"
                    behavior="alternate">
    ...
    <div>
        <div id="popup"
            class="ui-dialog ui-widget ui-widget-content ui-corner-all ui-shadow ui-hidden-container center-position">
            <div class="ui-dialog-titlebar ui-widget-header ui-helper-clearfix ui-corner-top"><span id="popup_title"
                    class="ui-dialog-title"></span></div>
            <div class="ui-dialog-content ui-widget-content" id="popup_content">
                <div id="j_idt50" class="ui-messages ui-widget" aria-live="polite"></div><button id="j_idt51"
                    name="j_idt51" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                    onclick="PrimeFaces.bcn(this,event,[function(event){mojarra.ab('j_idt51',event,'click',0,'loginPanel popup')},function(event){PrimeFaces.ab({s:&quot;j_idt51&quot;,f:&quot;master_Layout_form&quot;,onco:function(xhr,status,args){PF('dlg1').hide();;}});return false;}]);"
                    type="submit"><span class="ui-button-text ui-c">Ok</span></button>
        ...
        <div id="j_idt52"
            ...
            <div class="ui-dialog-titlebar ui-widget-header ui-helper-clearfix ui-corner-top"><span id="j_idt52_title"
                    class="ui-dialog-title"></span><a href="#"
            ...
            <div class="ui-dialog-content ui-widget-content" id="j_idt52_content"><span
                    class="ui-icon ui-confirm-dialog-severity"></span><span class="ui-confirm-dialog-message"></span>
            </div>
            <div class="ui-dialog-buttonpane ui-dialog-footer ui-widget-content ui-helper-clearfix"><button id="j_idt53"
                    name="j_idt53"
                    class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-left ui-confirmdialog-yes"
                    type="button"><span class="ui-button-icon-left ui-icon ui-c ui-icon-check"></span><span
                        class="ui-button-text ui-c">Yes</span></button>
                ...
                </script><button id="j_idt55" name="j_idt55"
                    class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-left ui-confirmdialog-no"
                    type="button"><span class="ui-button-icon-left ui-icon ui-c ui-icon-close"></span><span
                        class="ui-button-text ui-c">No</span></button>
                ...
                <div id="main">
                    <div class="ui-grid-row center-position" id="skip-main-content">
                        <div class="ui-grid-col-12"><img
                                src="https://checkpost.parivahan.gov.in/checkpost/faces/javax.faces.resource/NewImage.gif?ln=images" />
                                ...
                                <div class="ui-grid-col-11">
                                    <div class="panel panel-primary">
                                        <div class="panel-heading "><span
                                                class="glyphicon glyphicon-th-list"></span>Important information...
                                        </div>
                                        <div class="panel-body">
                                            <div class="news_h">
                                                <ul class="demo2">
                                                    <li class="news-item">Process to pay other state road tax of single
                                                        vehicle..<br /><a id="j_idt62" href="#"
                                                            class="ui-commandlink ui-widget"
                                                            onclick="PF('process1').show();;PrimeFaces.ab({s:&quot;j_idt62&quot;,f:&quot;master_Layout_form&quot;});return false;">Read
                                                            more...</a></li>
                                                    <li class="news-item">Process to check your pending transaction of
                                                        single vehicle..<br /><a id="j_idt65" href="#"
                                                            class="ui-commandlink ui-widget"
                                                            onclick="PF('process2').show();;PrimeFaces.ab({s:&quot;j_idt65&quot;,f:&quot;master_Layout_form&quot;});return false;">Read
                                                            more...</a></li>

                                                    <li class="news-item">Process to recheck the fail transaction of
                                                        single vehicle..<br /><a id="j_idt68" href="#"
                                                            class="ui-commandlink ui-widget"
                                                            onclick="PF('process3').show();;PrimeFaces.ab({s:&quot;j_idt68&quot;,f:&quot;master_Layout_form&quot;});return false;">Read
                                                            more...</a></li>
                                                    <li class="news-item">Process to signup for tax payment of more then
                                                        one vehicle in single transaction..<br /><a id="j_idt71"
                                                            href="#" class="ui-commandlink ui-widget"
                                                            onclick="PF('process4').show();;PrimeFaces.ab({s:&quot;j_idt71&quot;,f:&quot;master_Layout_form&quot;});return false;">Read
                                                            more...</a></li>
                                                    <li class="news-item">Process to pay other state road tax of more
                                                        then one vehicle..<br /><a id="j_idt74" href="#"
                                                            class="ui-commandlink ui-widget"
                                                            onclick="PF('process5').show();;PrimeFaces.ab({s:&quot;j_idt74&quot;,f:&quot;master_Layout_form&quot;});return false;">Read
                                                            more...</a></li>
                                                    <li class="news-item">Process to Generate Memo and pay fee of
                                                        ODC..<br /><a id="j_idt77" href="#"
                                                            class="ui-commandlink ui-widget"
                                                            onclick="PF('process6').show();;PrimeFaces.ab({s:&quot;j_idt77&quot;,f:&quot;master_Layout_form&quot;});return false;">Read
                                                            more...</a></li>
                                                </ul>
                                            </div>
                                        </div>
                            ...
                            <div class="ui-grid-row">
                                <div class="ui-grid-col-12  ">
                                    <div class="login-form text-center">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                <span class="input-group-addon"><i
                                                    ...
                                                    class="ui-inputfield ui-inputtext ui-widget ui-state-default ui-corner-all form-control no-copy-paste"
                                                    autocomplete="off" maxlength="30" placeholder="User Name" />
                                        ...
                                        <div id="captcha_panel" class="ui-outputpanel ui-widget">
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-5 col-sm-12 left-position"><img id="captchaImage"
                                                            src="https://checkpost.parivahan.gov.in/checkpost/DispplayCaptcha?txtp_cd=2&amp;bkgp_cd=2&amp;noise_cd=2&amp;gimp_cd=3&amp;txtp_length=5&amp;pfdrid_c=true527177114&amp;pfdrid_c=true"
                                                            alt="" class=" captch-but" />
                                                    </div>
                                                    <div class="col-md-2 col-sm-12 center-position"><button id="j_idt89"
                                                            name="j_idt89"
                                                            class="ui-button ui-widget ui-state-default ui-corner-all ui-button-icon-only vahan-captcha-refresh"
                                                            onclick="PrimeFaces.ab({s:&quot;j_idt89&quot;,f:&quot;master_Layout_form&quot;,u:&quot;captchaImage&quot;});return false;"
                                                            style="height: 30px;float: bottom;" type="submit"><span
                                                                class="ui-button-icon-left ui-icon ui-c ui-icon-refresh"></span><span
                                                                class="ui-button-text ui-c">ui-button</span></button>
                                                    ...
                                                    <div class="col-md-12 left-position">
                                                        <div class="input-group">
                                                            <span class="input-group-addon"><i
                                                                ...
                                                                id="CaptchaID" name="CaptchaID" type="text"
                                                                class="ui-inputfield ui-inputtext ui-widget ui-state-default ui-corner-all form-control no-copy-paste"
                                                                autocomplete="off" maxlength="10"
                                                                placeholder="Input text shown in the above image" />
                                        ...
                                        <div class="form-group">
                                            <div class="ui-grid-row">
                                                <div class="ui-grid-col-12 center-position"><button id="btnisValidate"
                                                        name="btnisValidate"
                                                        class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-left btn btn-primary btn-block btn-login"
                                                        onclick="PrimeFaces.ab({s:&quot;btnisValidate&quot;,f:&quot;master_Layout_form&quot;,u:&quot;password_panel otp_panel popup captcha_panel&quot;,onst:function(cfg){PF('masterLayoutHomeVar').show();;},onsu:function(data,status,xhr){PF('masterLayoutHomeVar').hide();;}});return false;"
                                                        type="submit"
                                                        onkeypress="if (event.keyCode == 13)                                                                 this.submit();"><span
                                                            class="ui-button-icon-left ui-icon ui-c ui-icon-unlocked"></span><span
                                                            class="ui-button-text ui-c">Submit</span></button>
                                                    ...
                                                    </script><button id="btnrefresh" name="btnrefresh"
                                                        class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-left btn btn-primary btn-block "
                                                        onclick="PrimeFaces.ab({s:&quot;btnrefresh&quot;,f:&quot;master_Layout_form&quot;,u:&quot;password_panel otp_panel popup captcha_panel&quot;,onst:function(cfg){PF('masterLayoutHomeVar').show();;},onsu:function(data,status,xhr){PF('masterLayoutHomeVar').hide();;}});return false;"
                                                        type="submit"
                                                        onkeypress="if (event.keyCode == 13)                                                                 this.submit();"><span
                                                            class="ui-button-icon-left ui-icon ui-c ui-icon-refresh"></span><span
                                                            class="ui-button-text ui-c">Reset</span></button>
                                        ...
                                        <div style="float: left;margin-bottom: 10px;">Don't have an account ! <a
                                                id="j_idt94" href="#" class="ui-commandlink ui-widget"
                                                aria-label="Register for payment of multiple vehilces in single cart."
                                                onclick="PrimeFaces.ab({s:&quot;j_idt94&quot;,f:&quot;master_Layout_form&quot;});return false;"
                                                style="color:#007acc;text-decoration: underline;font-weight: bold;"
                                                title="Register for payment of multiple vehilces in single cart.">Sign
                                                up</a> here</div>
                                        <div style="float: right;margin-bottom: 10px;margin-right: 70px;"><a
                                                href="/checkpost/faces/admin/pages/ForgetPassword.xhtml"
                                                style="color:#007acc;text-decoration: underline;font-weight: bold;">Forget
                                                Password</a></div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="ch-item ch-img-1">
                                            <div class="ch-info-wrap">
                                                <div class="ch-info">
                                                    ...
                                                    <div class="ch-info-back"><a
                                                            href="/checkpost/faces/public/payment/TaxCollection.xhtml">
                                                            <h3>Tax Payment</h3>
                                                        </a>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="ch-item ch-img-3">
                                            <div class="ch-info-wrap">
                                                <div class="ch-info">
                                                    ...
                                                    <div class="ch-info-back"><a
                                                            href="/checkpost/faces/public/reports/PaymentReceipt.xhtml">
                                        ...
                                        <div class="ch-item ch-img-2">
                                            <div class="ch-info-wrap">
                                                <div class="ch-info">
                                                    ...
                                                    <div class="ch-info-back"><a
                                                            href="/checkpost/faces/public/payment/ChecklTransactionStatus.xhtml">
                                        ...
                                        <div class="ch-item ch-img-4">
                                            <div class="ch-info-wrap">
                                                <div class="ch-info">
                                                    ...
                                                    <div class="ch-info-back"><a
                                                            href="/checkpost/faces/public/reports/CheckReceiptDetails.xhtml">
                                        ...
                                        <div class="ch-item ch-img-5">
                                            <div class="ch-info-wrap">
                                                <div class="ch-info">
                                                    ...
                                                    <div class="ch-info-back"><a
                                                            href="/checkpost/faces/public/payment/ReverifyTransaction.xhtml">
                ...
                <div id="footer_view">
                    ...
                    <head id="j_idt115">
                        <link type="text/css" rel="stylesheet"
                            href="/checkpost/faces/javax.faces.resource/theme.css?ln=primefaces-checkposttheme" />
                        <link type="text/css" rel="stylesheet"
                            href="/checkpost/faces/javax.faces.resource/fa/font-awesome.css?ln=primefaces&amp;v=7.0" />
                        <script type="text/javascript">
                    ...
                    <body>
                        <div class="footer-news-bg top-space">
                            <div class="news_w">
                                <div data-direction="left" class="marquee-with-options">
                                    <marquee scrollamount="2" speed="10" onmouseover="this.stop();"
                                        onmouseout="this.start();" direction="left" behavior="alternate">
                            ...
                            <div class="ui-grid-row ">
                                ...
                                <div class="ui-grid-col-2">
                                    <div class="ui-grid-row  left-position ">
                                        <div class="ui-grid-col-12  "><img id="j_idt118"
                                                src="https://checkpost.parivahan.gov.in/checkpost/faces/javax.faces.resource/nic-logo.png?ln=images"
                                                alt="Parivahan Sewa" />
                                        </div>
                                    </div>
                                </div>
        ...
        <script type="text/javascript"
            src="/checkpost/faces/javax.faces.resource/jquery.bootstrap.newsbox.min.js?ln=side-js"></script>
        <script type="text/javascript">
        $(function() {
            $(".demo2").bootstrapNews({
                newsPerPage: 5,
        ...
        <div id="payment_dialog1"
            class="ui-dialog ui-widget ui-widget-content ui-corner-all ui-shadow ui-hidden-container"
            style="background-color: #d6e7ff;font-size: 11pt;">
            <div class="ui-dialog-titlebar ui-widget-header ui-helper-clearfix ui-corner-top"><span
                    id="payment_dialog1_title" class="ui-dialog-title">Process of paying road tax for other
                    state...</span><a href="#" class="ui-dialog-titlebar-icon ui-dialog-titlebar-close ui-corner-all"
            ...
            <div class="ui-dialog-content ui-widget-content" id="payment_dialog1_content">
                <ol>
                    <li> Select the <font class="dialog-highlight-text">'Tax Payment'</font> from <font
                            class="dialog-highlight-text">'Payment'</font> menu on home screen.</li><br />
                    ...
                    <li> Enter <font class="dialog-highlight-text">'Vehicle No.'</font> and click <font
                            class="dialog-highlight-text">'Get Details'</font> button to fill the details.</li><br />
                ...
                <div class="ui-grid-row top-space bottom-space">
                    <div class="ui-grid-col-12 center-position"><button id="j_idt125" name="j_idt125"
                            class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                            onclick="PrimeFaces.bcn(this,event,[function(event){PF('process1').hide();},function(event){PrimeFaces.ab({s:&quot;j_idt125&quot;,f:&quot;master_Layout_form&quot;});return false;}]);"
                            type="submit"><span class="ui-button-text ui-c">Close</span></button>
        ...
        <div id="payment_dialog2"
            class="ui-dialog ui-widget ui-widget-content ui-corner-all ui-shadow ui-hidden-container"
            style="background-color: #d6e7ff;font-size: 11pt;">
            <div class="ui-dialog-titlebar ui-widget-header ui-helper-clearfix ui-corner-top"><span
                    id="payment_dialog2_title" class="ui-dialog-title">Process to check your pending transaction of
                    single vehicle..</span><a href="#"
                    class="ui-dialog-titlebar-icon ui-dialog-titlebar-close ui-corner-all" aria-label="Close"><span
                        class="ui-icon ui-icon-closethick"></span></a></div>
            <div class="ui-dialog-content ui-widget-content" id="payment_dialog2_content">
                <ol>
                    <li> Select the <font class="dialog-highlight-text">'Check Pending Transaction'</font> from <font
                            class="dialog-highlight-text">'Payment'</font> menu on home screen.</li><br />
                ...
                <div class="ui-grid-row top-space bottom-space">
                    <div class="ui-grid-col-12 center-position"><button id="j_idt128" name="j_idt128"
                            class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                            onclick="PrimeFaces.bcn(this,event,[function(event){PF('process2').hide();},function(event){PrimeFaces.ab({s:&quot;j_idt128&quot;,f:&quot;master_Layout_form&quot;});return false;}]);"
                            type="submit"><span class="ui-button-text ui-c">Close</span></button>
        ...
        <div id="payment_dialog3"
            class="ui-dialog ui-widget ui-widget-content ui-corner-all ui-shadow ui-hidden-container"
            style="background-color: #d6e7ff;font-size: 11pt;">
            <div class="ui-dialog-titlebar ui-widget-header ui-helper-clearfix ui-corner-top"><span
                    id="payment_dialog3_title" class="ui-dialog-title">Process to recheck the fail transaction of single
                    vehicle..</span><a href="#" class="ui-dialog-titlebar-icon ui-dialog-titlebar-close ui-corner-all"
                    aria-label="Close"><span class="ui-icon ui-icon-closethick"></span></a></div>
            <div class="ui-dialog-content ui-widget-content" id="payment_dialog3_content">
                <ol>
                    <li> Select the <font class="dialog-highlight-text">'Reverify Fail Transaction'</font> from <font
                            class="dialog-highlight-text">'Payment'</font> menu on home screen.</li><br />
                    ...
                    <li> Enter <font class="dialog-highlight-text">'Vehicle No.'</font> and click <font
                            class="dialog-highlight-text">'Get Details'</font> button to fill the details of the
                        vehicle.</li><br />
                ...
                <div class="ui-grid-row top-space bottom-space">
                    <div class="ui-grid-col-12 center-position"><button id="j_idt131" name="j_idt131"
                            class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                            onclick="PrimeFaces.bcn(this,event,[function(event){PF('process3').hide();},function(event){PrimeFaces.ab({s:&quot;j_idt131&quot;,f:&quot;master_Layout_form&quot;});return false;}]);"
                            type="submit"><span class="ui-button-text ui-c">Close</span></button>
        ...
        <div id="payment_dialog4"
            class="ui-dialog ui-widget ui-widget-content ui-corner-all ui-shadow ui-hidden-container"
            style="background-color: #d6e7ff;font-size: 11pt;">
            <div class="ui-dialog-titlebar ui-widget-header ui-helper-clearfix ui-corner-top"><span
                    id="payment_dialog4_title" class="ui-dialog-title">Process to signup for tax payment of more then
                    one vehicle in single transaction..</span><a href="#"
                    class="ui-dialog-titlebar-icon ui-dialog-titlebar-close ui-corner-all" aria-label="Close"><span
                        class="ui-icon ui-icon-closethick"></span></a></div>
            <div class="ui-dialog-content ui-widget-content" id="payment_dialog4_content">
                <ol>
                    ...
                    <li> Enter <font class="dialog-highlight-text">'OTP'</font> and desired <font
                            class="dialog-highlight-text">'Password'</font>.</li><br />
                ...
                <div class="ui-grid-row top-space bottom-space">
                    <div class="ui-grid-col-12 center-position"><button id="j_idt134" name="j_idt134"
                            class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                            onclick="PrimeFaces.bcn(this,event,[function(event){PF('process4').hide();},function(event){PrimeFaces.ab({s:&quot;j_idt134&quot;,f:&quot;master_Layout_form&quot;});return false;}]);"
                            type="submit"><span class="ui-button-text ui-c">Close</span></button>
        ...
        <div id="payment_dialog5"
            class="ui-dialog ui-widget ui-widget-content ui-corner-all ui-shadow ui-hidden-container"
            style="background-color: #d6e7ff;font-size: 11pt;">
            <div class="ui-dialog-titlebar ui-widget-header ui-helper-clearfix ui-corner-top"><span
                    id="payment_dialog5_title" class="ui-dialog-title">Process to pay other state road tax of more then
                    one vehicle..</span><a href="#"
                    class="ui-dialog-titlebar-icon ui-dialog-titlebar-close ui-corner-all" aria-label="Close"><span
                        class="ui-icon ui-icon-closethick"></span></a></div>
            <div class="ui-dialog-content ui-widget-content" id="payment_dialog5_content">
                <ol>
                    <li> Enter <font class="dialog-highlight-text">'User ID'</font> and <font
                            class="dialog-highlight-text">'Password'</font> generated with <font
                            class="dialog-highlight-text">'Signup here'</font> link.</li><br />
                    <li> Enter captcha as shown in the image.</li><br />
                    <li> Select the <font class="dialog-highlight-text">'Tax Payment'</font> from <font
                            class="dialog-highlight-text">'Select Menu'</font> drop down menu.</li><br />
                    <li> Select service Name from <font class="dialog-highlight-text">'Service Name'</font> drop down
                        menu.</li><br />
                    <li> Click <font class="dialog-highlight-text">'Go'</font> button to open the vehicle details form.
                    </li><br />
                ...
                <div class="ui-grid-row top-space bottom-space">
                    <div class="ui-grid-col-12 center-position"><button id="j_idt137" name="j_idt137"
                            class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                            onclick="PrimeFaces.bcn(this,event,[function(event){PF('process5').hide();},function(event){PrimeFaces.ab({s:&quot;j_idt137&quot;,f:&quot;master_Layout_form&quot;});return false;}]);"
                            type="submit"><span class="ui-button-text ui-c">Close</span></button>
        ...
        <div id="payment_dialog6"
            class="ui-dialog ui-widget ui-widget-content ui-corner-all ui-shadow ui-hidden-container"
            style="background-color: #d6e7ff;font-size: 11pt;">
            <div class="ui-dialog-titlebar ui-widget-header ui-helper-clearfix ui-corner-top"><span
                    id="payment_dialog6_title" class="ui-dialog-title">Process to Generate Memo and pay fee of
                    ODC..</span><a href="#" class="ui-dialog-titlebar-icon ui-dialog-titlebar-close ui-corner-all"
                    aria-label="Close"><span class="ui-icon ui-icon-closethick"></span></a></div>
            <div class="ui-dialog-content ui-widget-content" id="payment_dialog6_content">
                <ol>
                    <li>Select the <font class="dialog-highlight-text">'Tax Payment'</font> from <font
                            class="dialog-highlight-text">'Payment'</font> menu on home screen.</li>
                    <li>Select the state where you want to go from 'Select State' drop down menu.</li>
                    <li>Select service name from <font class="dialog-highlight-text">'Service Name'</font> as <font
                            class="dialog-highlight-text">'ADVANCE PAYMENT OF ODC EXEMPTION FEE'</font> from drop down
                        menu.</li>
                    <li>Click <font class="dialog-highlight-text">'Go'</font> button to open the vehicle details form.
                    </li>
                    <li>Enter <font class="dialog-highlight-text">'Vehicle No.'</font> and click <font
                            class="dialog-highlight-text">'Get Details'</font> button to fill the details.</li>
                    ...
                    <li>In case nature of goods of your vehicle is <font class="dialog-highlight-text">'INDIVISIBLE'
                        ...
                        <ol>
                            <li type="A">You can pay the fee at the same time by clicking on <font
                                    class="dialog-highlight-text">'Pay Fee'</font> button.
                                <ol>
                                    <li type="i">It opens the payment gateway of <font class="dialog-highlight-text">
                                            VAHAN</font>.</li>
                                    <li type="i">Choose payment gateway and click on <font
                                            class="dialog-highlight-text">'Continue'</font> button.</li>
                            ...
                            <li type="A">Or if you want to make payment later then note down your memo no and follow
                                ...
                                <ol>
                                    ...
                                    <li type="i">Select the state where you want to go from <font
                                            class="dialog-highlight-text">'Select State'</font> drop down menu.</li>
                ...
                <div class="ui-grid-row top-space bottom-space">
                    <div class="ui-grid-col-12 center-position"><button id="j_idt140" name="j_idt140"
                            class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                            onclick="PrimeFaces.bcn(this,event,[function(event){PF('process6').hide();},function(event){PrimeFaces.ab({s:&quot;j_idt140&quot;,f:&quot;master_Layout_form&quot;});return false;}]);"
                            type="submit"><span class="ui-button-text ui-c">Close</span></button>
    ...
    <div id="j_idt143" class="ui-blockui-content ui-widget ui-widget-content ui-corner-all ui-helper-hidden ui-shadow">
        <img id="j_idt144"
            src="https://checkpost.parivahan.gov.in/checkpost/faces/javax.faces.resource/ajax_loader_blue.gif?ln=images"
            alt="" />
    </div>
    ...
    </script><input type="hidden" name="javax.faces.ViewState" id="j_id1:javax.faces.ViewState:0"
        value="-743271855747581094:-4061995621272595198" autocomplete="off" />
</form>